...
/// </summary>
public unsafe class CharacterClassSubWindowHandler : GenericAddonHandler
{
  /// <summary>
  /// Initializes a new instance of the <see cref="CharacterClassSubWindowHandler"/> class.
  /// </summary>
  /// <param name="config">The configuration settings for the plugin.</param>
  /// <param name="translationService">The service used for translating text.</param>
  public CharacterClassSubWindowHandler(Config config, TranslationService translationService)
    : base("CharacterClass", config, translationService, useAtkValues: true, useStringArray: true, stringArrayDataType: StringArrayType.Character)
  {
