// <copyright file="SelectionDialogNodeResolvers.cs" company="lokinmodar">
...
/// <summary>
///     Shared node walkers for generic selection-dialog add-ons.
/// </summary>
internal static unsafe class SelectionDialogNodeResolvers
{
    /// <summary>
    ///     Resolves all readable text nodes in tree order.
    /// </summary>
    /// <param name="addon">The live addon.</param>
    /// <returns>The readable text-node addresses.</returns>
    ...
    /// <summary>
    ///     Reads the visible text from one text node.
    /// </summary>
        ...
        HashSet<nint> seen)
    {
        ...
        {
            CollectReadableTextNodes(nodeList[index], results, seen);
        }
    }
