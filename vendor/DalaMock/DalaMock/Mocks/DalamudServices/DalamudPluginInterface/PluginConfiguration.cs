...
public class PluginConfiguration
{
    ...
    {
        return new FileInfo(Path.Combine(this.configDirectory.FullName, $"{pluginName}.json"));
    }
    ...
    {
        return new DirectoryInfo(Path.Combine(this.configDirectory.FullName, pluginName));
    }
}
