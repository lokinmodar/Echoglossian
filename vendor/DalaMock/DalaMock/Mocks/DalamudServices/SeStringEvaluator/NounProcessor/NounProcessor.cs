namespace DalaMock.Core.Mocks.DalamudServices.SeStringEvaluator.NounProcessor;
...
/// </summary>
public class NounProcessor
{
    private readonly MockDalamudConfiguration dalamudConfiguration;
    private readonly IDataManager dataManager;
    private readonly ILogger<NounProcessor> logger;
    ...
    public NounProcessor(MockDalamudConfiguration dalamudConfiguration, IDataManager dataManager, ILogger<NounProcessor> logger)
    {
    ...
    private ReadOnlySeString ResolveNounJa(NounParams nounParams)
    {
        ...
        {
            this.logger.LogWarning("Sheet {SheetName} does not contain row #{RowId}", nounParams.SheetName, nounParams.RowId);
            return default;
        }
