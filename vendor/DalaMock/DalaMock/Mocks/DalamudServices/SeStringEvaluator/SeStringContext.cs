namespace DalaMock.Core.Mocks.DalamudServices.SeStringEvaluator;
...
internal readonly ref struct SeStringContext
{
    ...
    /// </summary>
    internal readonly LuminaSeStringBuilder Builder;
    ...
    internal SeStringContext(LuminaSeStringBuilder builder, Span<SeStringParameter> localParameters, ClientLanguage language)
    {
