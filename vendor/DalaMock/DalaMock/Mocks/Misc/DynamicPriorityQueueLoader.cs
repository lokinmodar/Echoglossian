...
public class DynamicPriorityQueueLoader : IDisposable
{
    ...
    {
        this.newItemChannel = Channel.CreateUnbounded<WorkItem>(new UnboundedChannelOptions { SingleReader = true });
        this.workTokenChannel = Channel.CreateUnbounded<object?>(new UnboundedChannelOptions { SingleWriter = true });
    ...
    public interface IThrottleBasisProvider
    {
