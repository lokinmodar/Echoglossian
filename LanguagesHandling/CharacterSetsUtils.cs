...
namespace Echoglossian
{
  public partial class Echoglossian
  {
    ...
    public readonly HashSet<char> SpecialCharsSupportedByGameFont = new HashSet<char>
    {
    'À', 'Á', 'Â', 'Ã', 'Ä', 'Å', 'Æ', 'Ç', 'È', 'É', 'Ê', 'Ë', 'Ì', 'Í', 'Î', 'Ï', 'Ð', 'Ñ',
    'Ò', 'Ó', 'Ô', 'Õ', 'Ö', 'Ø', 'Ù', 'Ú', 'Û', 'Ü', 'Ý', 'Þ', 'ß', 'à', 'á', 'â', 'ã', 'ä',
    'å', 'æ', 'ç', 'è', 'é', 'ê', 'ë', 'ì', 'í', 'î', 'ï', 'ð', 'ñ', 'ò', 'ó', 'ô', 'õ', 'ö',
    'ø', 'ù', 'ú', 'û', 'ü', 'ý', 'þ', 'ÿ', 'ă', 'Œ', 'œ', 'Š', 'š', 'Ÿ', 'À', 'Á', 'Â',
    'Ã', 'È', 'É', 'Ê', 'Ì', 'Í', 'Ò', 'Ó', 'Ô', 'Ù', 'Ú', 'Ý', 'à', 'á', 'â', 'ã', 'è', 'é',
    'ê', 'ì', 'í', 'ò', 'ó', 'ô', 'ù', 'ú', 'ý', 'ă', 'â', 'ê', 'î', 'ô', 'û', 'Â', 'Ê', 'Î',
    'Ô', 'Û', 'ë', 'ï', 'ü', 'Ë', 'Ï', 'Ü', 'ç', 'Ç', 'œ', 'Œ', 'æ', 'Æ', 'ø', 'Ø', 'å', 'Å',
    'ä', 'ö', 'ü', 'ß', 'Ä', 'Ö', 'Ü', 'à', 'è', 'é', 'ì', 'ò', 'ù', 'À', 'È', 'É', 'Ì', 'Ò',
    'Ù', 'á', 'é', 'í', 'ó', 'ú', 'ñ', 'Á', 'É', 'Í', 'Ó', 'Ú', 'Ñ', 'ä', 'ö', 'ü', 'ß', 'Ä',
    'Ö', 'Ü', 'à', 'â', 'ç', 'è', 'é', 'ê', 'î', 'ï', 'ô', 'û', 'ù', 'À', 'Â', 'Ç', 'È', 'É',
    'Ê', 'Î', 'Ï', 'Ô', 'Û', 'Ù', 'ò', 'ù', 'è', 'é', 'ì', 'í', 'ò', 'ó', 'ù', 'ú', 'ò', 'Ó',
    'Ù', 'È', 'É', 'Ì', 'Í', 'Ò', 'Ó', 'Ú', 'á', 'é', 'í', 'ñ', 'ó', 'ú', 'Á', 'É', 'Í', 'Ñ',
    'Ó', 'Ú', 'á', 'é', 'í', 'ó', 'ú', 'ý', 'Á', 'É', 'Í', 'Ó', 'Ú', 'Ý', 'ã', 'õ', 'Ã', 'Õ',
    'ă', 'î', 'â', 'Î', 'Â', 'å', 'ä', 'ö', 'Å', 'Ä', 'Ö', 'ć', 'š', 'Š', 'õ', 'Õ', 'ø', 'Ø',
    };
  }
}
