...
namespace Echoglossian.EFCoreSqlite.Migrations
{
    ...
    [Migration("20260427182257_AddEventAndDeepDungeonItemTextTables")]
    partial class AddEventAndDeepDungeonItemTextTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Echoglossian.EFCoreSqlite.Models.DeepDungeonItemText", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ReferenceId", "TranslationLang", "TranslationEngine", "GameVersion", "SourceContentHash")
                        .HasDatabaseName("IX_deepdungeonitemtexts_lookup");

                    b.ToTable("deepdungeonitemtexts", (string)null);
                });
            ...
            modelBuilder.Entity("Echoglossian.EFCoreSqlite.Models.EventItemText", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ReferenceId", "TranslationLang", "TranslationEngine", "GameVersion", "SourceContentHash")
                        .HasDatabaseName("IX_eventitemtexts_lookup");

                    b.ToTable("eventitemtexts", (string)null);
                });
