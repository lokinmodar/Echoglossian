...
public partial class Echoglossian
{
  ...
  /// </summary>
  /// <param name="data">The <see cref="StringArrayDatas" /> instance to format.</param>
  /// <returns>A formatted <see cref="StringArrayDatas" /> for database storage.</returns>
  public StringArrayDatas FormatStringArrayDatas(StringArrayDatas data)
  {
    return new StringArrayDatas(
        ...
        data.OriginalLang,
        data.OriginalStrings,
        data.TranslationLang,
        data.TranslatedStrings,
        data.TranslatedStringsWithPayloads,
        data.TranslationEngine,
        data.GameVersion,
        data.CreatedAt,
        data.UpdatedAt);
  }
