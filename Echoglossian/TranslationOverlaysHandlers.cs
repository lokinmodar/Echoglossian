...
namespace Echoglossian
{
  public partial class Echoglossian
  {
    ...
    private string currentNameToTranslate = string.Empty;
    ...
    private string currentTalkToTranslate = string.Empty;
    ...
    private void DrawTranslatedBattleDialogueWindow()
    {
      ImGuiHelpers.SetNextWindowPosRelativeMainViewport(
        new Vector2(
          ...
          this.battleTalkTextPosition.Y - this.battleTalkTextImguiSize.Y - 20) +
      ...
      ImGui.SetNextWindowSizeConstraints(
        new Vector2(size, 0),
        new Vector2(size, this.battleTalkTextDimensions.Y * 2.5f * this.configuration.ImGuiBattleTalkWindowHeightMult));
    ...
    private void DrawTranslatedDialogueWindow()
    {
      ...
      ImGui.SetNextWindowSizeConstraints(
        new Vector2(size, 0),
        new Vector2(size, this.talkTextDimensions.Y * this.configuration.ImGuiTalkWindowHeightMult));
      ...
      if (this.configuration.UseImGuiForToasts && this.configuration.TranslateToast && this.toastDisplayTranslation)
      {
        ImGuiHelpers.SetNextWindowPosRelativeMainViewport(
          new Vector2(
            ...
            this.toastTranslationTextPosition.Y - this.toastTranslationTextImguiSize.Y - 20) +
        ...
        ImGui.SetNextWindowSizeConstraints(
          new Vector2(size, 0),
          new Vector2(size * 4f, this.toastTranslationTextDimensions.Y * 2));
        ImGui.PushStyleColor(ImGuiCol.Text, new Vector4(this.configuration.OverlayTextColor, 255));
        if (this.FontLoaded)
        {
#if DEBUG
    ...
    private void DrawTranslatedErrorToastWindow()
    {
      ...
      ImGuiHelpers.SetNextWindowPosRelativeMainViewport(
        new Vector2(
          ...
          this.errorToastTranslationTextPosition.Y - this.errorToastTranslationTextImguiSize.Y - 20) +
        this.configuration.ImGuiToastWindowPosCorrection);
      var size = Math.Min(
    ...
    private void DrawTranslatedClassChangeToastWindow()
    {
      ...
      ImGuiHelpers.SetNextWindowPosRelativeMainViewport(
        new Vector2(
          ...
          this.classChangeToastTranslationTextPosition.Y - this.classChangeToastTranslationTextImguiSize.Y - 20) +
        this.configuration.ImGuiToastWindowPosCorrection);
      var size = Math.Min(
