...
namespace Echoglossian
{
  public partial class Echoglossian
  {
    ...
    private void EchoglossianConfigUi()
    {
      ...
      var languageOnlySupportedThruOverlay = this.configuration.Lang is 2 or 4 or 6 or 8 or 9 or 10 or 12 or 14 or 15
      ...
      if (ImGui.BeginTabBar("TabBar", ImGuiTabBarFlags.None))
      {
        if (ImGui.BeginTabItem(Resources.ConfigTab0Name))
        {
          ...
          if (this.configuration.Translate)
          {
            ...
            if (languageNotSupported)
            {
              ...
              var translationsDisabled = this.DisableAllTranslations();
                  ...
                  ref this.configuration.TranslateToast))
            {
              ...
              {
                var toastTranslationsDisabled = this.DisableAllToastTranslations();
              }
          ...
          else
          {
            ...
            var disabledTranslations = this.DisableAllTranslations();
            this.SaveConfig();
          }
              ...
              ref this.configuration.TranslateTalk))
        {
          ...
          if (languageOnlySupportedThruOverlay || this.configuration.UseImGuiForTalk)
          {
              ...
              ref this.configuration.TranslateToast))
        {
          ...
          if (this.configuration.TranslateToast)
          {
            ...
            if (languageOnlySupportedThruOverlay || this.configuration.UseImGuiForToasts)
            {
              ImGui.Text(Resources.ImguiAdjustmentsLabel);
              ...
              if (ImGui.DragFloat(
                    ...
                    ref this.configuration.ImGuiToastWindowWidthMult,
                    0.001f,
                    0.01f,
                    3f))
              {
      ...
      ImGui.PushStyleColor(
        ImGuiCol.Button,
        new Vector4(1 / 7.0f, 0.6f, 0.6f, 1f));
      ImGui.PushStyleColor(
        ImGuiCol.ButtonHovered,
        new Vector4(1 / 7.0f, 0.7f, 0.7f, 1f));
      ImGui.PushStyleColor(
        ImGuiCol.ButtonActive,
        new Vector4(1 / 7.0f, 0.8f, 0.8f, 1f));
      ...
      ImGui.PushStyleColor(
        ImGuiCol.ButtonHovered,
        new Vector4(4, 7.0f, 0.7f, 0.7f));
      ImGui.PushStyleColor(
        ImGuiCol.ButtonActive,
        new Vector4(4, 7.0f, 0.8f, 0.8f));
