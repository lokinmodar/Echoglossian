...
namespace Echoglossian
{
  public partial class Echoglossian
  {
    ...
    private void GrabAddonEventInfo(AddonEvent type, AddonArgs args)
    {
      ...
      switch (args.Type)
      {
        case AddonArgsType.Setup:
          ...
          break;
       /* case AddonArgsType.:
          this.HandleUpdateArgs((AddonArgs)args);
          break;*/
        case AddonArgsType.Show:
          this.HandleDrawArgs((AddonArgs)args);
          break;
        case AddonArgsType.Hide:
          this.HandleFinalizeArgs((AddonArgs)args);
          break;
    ...
    private unsafe void HandleUpdateArgs(AddonArgs args)
    {
      if (args == null)
      {
        return;
    ...
    private void HandleDrawArgs(AddonArgs args)
    {
      if (args == null)
      {
        return;
    ...
    private void HandleFinalizeArgs(AddonArgs args)
    {
      if (args == null)
      {
        return;
