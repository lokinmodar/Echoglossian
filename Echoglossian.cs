...
public partial class Echoglossian : IDalamudPlugin
{
    ...
    [PluginService] public static IDataManager DManager { get; private set; }

    [PluginService]
    public static IDalamudPluginInterface PluginInterface { get; } = null!;

    [PluginService]
    public static ICommandManager CommandManager { get; } = null!;

    [PluginService]
    public static IFramework FrameworkInterface { get; } = null!;

    [PluginService] public static IGameGui GameGuiInterface { get; } = null!;

    [PluginService]
    public static IChatGui ChatGuiInterface { get; private set; } = null!;

    [PluginService]
    public static IClientState ClientStateInterface { get; } = null!;

    [PluginService] public static IToastGui ToastGuiInterface { get; } = null!;

    [PluginService]
    public static IAddonEventManager EventManager { get; private set; } = null!;

    [PluginService]
    public static IAddonLifecycle AddonLifecycle { get; } = null!;

    [PluginService] public static IPluginLog PluginLog { get; } = null!;

    [PluginService]
    public static INotificationManager NotificationManager { get; } = null!;

    [PluginService]
    public static ITextureProvider TextureProvider { get; } = null!;
